...
public class RelatorioRecyclewViewAdapter extends RecyclerView.Adapter<RelatorioRecyclewViewAdapter.MyViewHolder> {
    private List<EtapasRelatorioObj> listaRel;

    public RelatorioRecyclewViewAdapter(List<EtapasRelatorioObj> lista){
        this.listaRel = lista;
    }
